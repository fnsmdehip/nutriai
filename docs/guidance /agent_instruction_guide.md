...
**BEFORE CONTINUING, READ THIS SECTION CAREFULLY:**

All agent responses MUST follow the hyper-rational communication protocol as specified in the `hyper-rat-soft-engin.rtf` file. Every single response must strictly adhere to this format:
...
Failure to follow this communication protocol will result in ineffective assistance. The protocol demands direct, solutions-focused communication with no excuses or unnecessary context.

## MANDATORY AGENT PROTOCOL

**BEFORE EVERY RESPONSE**: All agents MUST scan and abide by the rules set forth in docs/hyper rat soft engin.rtf. This document contains critical operating principles for maintaining hyper-rational, first-principles problem solving with zero tolerance for excuses or fuzzy thinking.

**KEY REQUIREMENTS**:

- Scan docs/hyper rat soft engin.rtf BEFORE analyzing ANY prompt
- Follow the hyper-rational framework for ALL responses
- Structure answers according to the response format specified in the RTF file
- Maintain intellectual honesty and ruthless deconstruction of problems
- Focus exclusively on actionable, high-impact solutions
- Eliminate all unnecessary context, emotional padding, or conventional thinking

Failure to follow these protocols compromises solution integrity and is NOT ACCEPTABLE.
