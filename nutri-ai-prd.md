...
- Workout frequency selection (0-2, 3-5, 6+) with descriptive text:
  ...
  * "6+: Dedicated athlete"
- Attribution tracking with scrollable options list:
  * "Where did you hear about us?" heading
  * Single scrollable screen with all options:
    - Instagram
    - Facebook
    - TikTok
    - YouTube
    ...
    - Friend or family
    - Other
  * No pagination or multiple screens - just vertical scrolling for additional options
  * Light gray selection buttons
...
- Diet type selection (Classic, Pescatarian, Vegetarian, Vegan)
- Obstacles identification ("What's stopping you from reaching your goals?") with options:
  * Lack of consistency (chart icon)
  * Unhealthy eating habits (burger icon)
  * Lack of support (handshake icon)
  * Busy schedule (calendar icon)
  * Lack of meal inspiration (apple icon)
- Personal aims selection ("What would you like to accomplish?") with options:
  * Eat and live healthier (apple icon)
  * Boost my energy and mood (sun icon)
  * Stay motivated and consistent (muscle icon)
  * Feel better about my body (meditation icon)
...
- Option to connect with health apps (Apple Health/Google Fit)
